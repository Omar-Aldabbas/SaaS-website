...
export const Contact = () => {
  return (
    <section className="bg-secondary grid grid-cols-1 md:grid-cols-2 p-8 justify-center items-center gap-5 max-h-screen">
      <div className="flex flex-col gap-4 p-2">
        ...
        <p className="text-brand text-sm md:text-base">
          Biccas makes managing your money simple, fast, and secure — anytime,
          anywhere.
        </p>
        ...
        <div className="flex p-2 gap-2 items-center">
          <img
            src={Goerge}
            alt="Old person"
            className="p-1 rounded-full w-12 h-12 object-cover"
          />
          <img
            src={Beardy}
            alt="Person with beard"
            className="p-1 rounded-full w-12 h-12 object-cover"
          />
          <img
            src={Singh}
      ...
      <div className="flex justify-center items-center">
        <div className="bg-secondary-foreground p-4 md:p-6 rounded-xl w-full max-w-sm flex flex-col gap-3">
          ...
          <input
            ...
            className="p-2 rounded-lg w-full bg-white text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary"
          />

          <label className="text-white font-medium text-sm">Message</label>
          <textarea
            placeholder="What are you say?"
            className="p-2 rounded-lg w-full bg-white text-foreground text-sm h-20 resize-none focus:outline-none focus:ring-2 focus:ring-primary"
          />
